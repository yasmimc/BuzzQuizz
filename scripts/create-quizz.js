	...
	screenInfos.innerHTML += `<h1>Comece pelo começo</h1>
                                <div class="basic-quiz-info">
                                    <div class="box-information">
										...
										<p class="amount-question not-number-err hidden">O valor inserido não é um número válido</p>
										...
										<p class=" amount-level not-number-err hidden">O valor inserido não é um número válido</p>
                                    </div>
                                </div>
...
function validateInformation() {
	...
	if (typeof (numberQuestions) !== Number) {
